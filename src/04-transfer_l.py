...
# Save the weights of the model in a custom file
torch.save(alexnet.state_dict(), r'../models/custom_alexnet_model.pth')
print("Model saved to custom_alexnet_model.pth")